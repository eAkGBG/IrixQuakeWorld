...
// Define GL functions that might be missing
...
typedef void (APIENTRY * TEXSUBIMAGE2DFUNCPTR) (GLenum target, GLint level, 
                                              GLint xoffset, GLint yoffset,
                                              GLsizei width, GLsizei height,
                                              GLenum format, GLenum type,
                                              const GLvoid *pixels);

// Replace the problematic declarations:
extern BINDTEXFUNCPTR bindTexFunc;
extern DELTEXFUNCPTR delTexFunc;
extern TEXSUBIMAGE2DFUNCPTR TexSubImage2DFunc;
